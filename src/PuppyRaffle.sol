...
contract PuppyRaffle is ERC721, Ownable {
    ...
    //@audit have a check for duplicates
        //Below for loop should be at the begenining
    ...
    /// @dev we use a hash of on-chain data to generate the random numbers //@Q Check this again there might chance to enter again and again
    ...
    //@audit thhis should be only owner function
